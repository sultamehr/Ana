...
// Sun Oct 25 16:37:52 2015 by ROOT version 5.34/05
// from TTree Truth/Tuple created by an AnaTuple managed by AnaTupleManager
// found on file: /pnfs/minerva/persistent/users/drut1186/mmdccqe_minosbugfix/grid/central_value/minerva/ana/v10r8p7/00/01/02/00/SIM_minerva_00010200_Subruns_0001-0002-0003-0004_CCQENu_Ana_Tuple_v10r8p7-drut1186.root
//////////////////////////////////////////////////////////

#ifndef CCQENuTruth_h
#define CCQENuTruth_h
...
public :
   ...
   // Below 2 GENIE variables are missing from Dan's processing on 10/20/2015, but he should add them back in (update AnaTuple.cpp)
   ...
   //TBranch      *b_mc_wgt_GENIE[100];   //[mc_wgt_GENIE_sz]
...
#ifdef CCQENuTruth_cxx
CCQENU_ANA::CCQENuTruth::CCQENuTruth(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/minerva/persistent/users/drut1186/mmdccqe_minosbugfix/grid/central_value/minerva/ana/v10r8p7/00/01/02/00/SIM_minerva_00010200_Subruns_0001-0002-0003-0004_CCQENu_Ana_Tuple_v10r8p7-drut1186.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/minerva/persistent/users/drut1186/mmdccqe_minosbugfix/grid/central_value/minerva/ana/v10r8p7/00/01/02/00/SIM_minerva_00010200_Subruns_0001-0002-0003-0004_CCQENu_Ana_Tuple_v10r8p7-drut1186.root");
      }
...
CCQENU_ANA::CCQENuTruth::~CCQENuTruth()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CCQENU_ANA::CCQENuTruth::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CCQENU_ANA::CCQENuTruth::LoadTree(Long64_t entry)
{
...
void CCQENU_ANA::CCQENuTruth::Init(TTree *tree)
{
...
Bool_t CCQENU_ANA::CCQENuTruth::Notify()
{
...
void CCQENU_ANA::CCQENuTruth::Show(Long64_t entry)
{
...
Int_t CCQENU_ANA::CCQENuTruth::Cut(Long64_t entry)
{
